...
public class Magnet implements View.OnTouchListener {
    ...
    private int res1, res2, resMoreThan2;
    ...
    public static class Builder {
        ...
        public Builder withResource(int position, @DrawableRes int resource) {
            switch (position) {
                case 1:
                    magnet.res2 = resource;

                case 2:
                    magnet.resMoreThan2 = resource;
                default:
                case 0:
                    magnet.res1 = resource;
                    break;
            }
            return this;
        }
    ...
    public void show() {
        if (previousView != null) {
            ++notifications;
            mWindowManager.removeView(previousView);
        }
        previousView = mIconView;
        if (mIconView instanceof ImageView) {
            int res = notifications == 0 ? res1 :
                    notifications == 1 ? res2 : resMoreThan2;
            ((ImageView) mIconView).setImageResource(res);
        }
